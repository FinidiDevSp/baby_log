...
class _TemperatureLogPageState extends ConsumerState<TemperatureLogPage> {
  ...
  void _adjustTemperature(double delta) {
    final newValue = (_temperature + delta).clamp(30.0, 42.0);
    _temperatureController.text = newValue.toStringAsFixed(1);
    setState(() {});
  }
  ...
  Future<void> _save(BuildContext context) async {
    ...
    if (temperature <= 0) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(l10n.temperatureLogValueValidation)),
      );
      return;
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text(l10n.temperatureLogTitle),
      ),
      body: SafeArea(
        child: ListView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      _TemperatureActionButton(
                        icon: LucideIcons.minus,
                        tooltip: l10n.temperatureLogDecreaseTooltip,
                        onPressed: () => _adjustTemperature(-0.1),
                      ),
                      ...
                      _TemperatureActionButton(
                        ...
                        tooltip: l10n.temperatureLogIncreaseTooltip,
                        onPressed: () => _adjustTemperature(0.1),
                      ),
                    ],
                  ),
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: l10n.temperatureLogNotesHint,
                      filled: true,
...
class _TemperatureActionButton extends StatelessWidget {
  const _TemperatureActionButton({
    required this.icon,
