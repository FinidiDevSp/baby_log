...
class _BathLogPageState extends ConsumerState<BathLogPage> {
  ...
  Future<void> _save(BuildContext context) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text(l10n.formSaveError('$error'))));
    }
  }
                ...
                children: [
                    ...
                    children: [
                      Expanded(
                        child: _TypeOptionButton(
                          ...
                          isSelected: _selectedType == BathType.full,
                          onTap: () {
                            setState(() {
                              _selectedType = BathType.full;
                            });
                      ...
                      Expanded(
                        child: _TypeOptionButton(
                          ...
                          isSelected: _selectedType == BathType.quick,
                          onTap: () {
                            setState(() {
                              _selectedType = BathType.quick;
                            });
                          },
                        ),
                      ),
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: l10n.bathLogNotesHint,
                      filled: true,
